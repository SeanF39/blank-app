...
export default function Page() {
  const rows = projects.filter((p) => 'compliance' === 'flynn' ? p.entity === 'Flynn Advisors' : 'compliance' === 'manifest' ? p.entity === 'Manifest Industries' : true);
  return <Shell>
